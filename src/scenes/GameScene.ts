...
const WEAPON_EVOLUTIONS: WeaponEvolution[] = [
  ...
  },
  {
    ...
    to: "infernoTide",
    title: "Inferno Tide",
    subtitle: "Fire Trail + Scroll of Embers — the ground itself ignites in a roaring wall of endless flame!",
  ...
  },
  {
    ...
    to: "holyDeluge",
    title: "Holy Deluge",
    subtitle: "Holy Water + Sacred Chalice — a cascade of sanctified vials drowns the battlefield in divine fire!",
  ...
  },
  {
    ...
    gear: "diceCharm",
    to: "catastrophicBeam",
    title: "Catastrophic Beam",
    subtitle: "Laser Pointer + Lucky D20 — every cat in the realm descends in a frenzied storm of red dots!",
    spriteKey: "laser-dot",
  },
  {
    from: "frostbolt",
    ...
    to: "glacialLance",
    title: "Glacial Lance",
    subtitle: "Frostbolt + Scroll of Frost — a piercing icicle spear that freezes entire ranks solid!",
    spriteKey: "frostbolt",
  },
  {
    from: "poisonCloud",
    ...
    to: "plagueMiasma",
    title: "Plague Miasma",
    subtitle: "Poison Cloud + Scroll of Rot — rolling banks of festering fog blanket the battlefield in lasting decay!",
  ...
  },
  {
    ...
    to: "ballista",
    title: "Ballista",
    subtitle: "Crossbow + Scroll of Stone — a monstrous siege bolt that punches through entire enemy ranks!",
  ...
  },
  {
    ...
    to: "tempest",
    title: "Tempest",
    subtitle: "Chain Lightning + Scroll of Storms — a roiling thunderhead arcs between dozens of foes at once!",
  ...
  },
  {
    ...
    to: "vengefulStar",
    title: "Vengeful Star",
    subtitle: "Homing Shuriken + Cursed Stamp — a swarm of cursed stars hunt their prey with serpentine relentlessness!",
    spriteKey: "shuriken",
  },
  {
    from: "krabbyPatty",
